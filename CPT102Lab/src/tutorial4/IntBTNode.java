...
public class IntBTNode {
     ...
     *
     * @return The tree starting at this node has had its leftmost node removed
     * (i.e., the deepest node that can be reached by following left links). The
     * return value is a reference to the root of the new (smaller) tree. This
     * return value could be null if the original tree had only one node (since
     ...
     *
     * @return The tree starting at this node has had its rightmost node removed
     * (i.e., the deepest node that can be reached by following right links).
     * The return value is a reference to the root of the new (smaller) tree.
     * This return value could be null if the original tree had only one node
