...
//        firstBag.addAll(firstBag);
        firstBag.addAll2(firstBag); //referred type 
        System.out.println("There are : "+firstBag.size() + " item(s) in the first bag");
        ...
        System.out.println("There are : "+intersectionBag.size() + " item(s) in the pintersectionBag");
//        intersectionBag.show();
//        part2.show();
        System.out.println("Element Removed Number: "+part2.removeMany(2,2,2,4));
//        part2.show();
